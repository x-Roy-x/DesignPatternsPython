...
class ExpressionEvaluator:
    ...
    @visitor(DoubleExpression)
    def eval(self, double_expression):
        self.value = double_expression.value

    @visitor(AdditionExpression)
    def eval(self, addition_expression):
        self.eval(addition_expression.left)
        temp = self.value
        self.eval(addition_expression.right)
        self.value += temp
